...
from src.storage import SQLiteSessionMemoryStore
...
async def main() -> None:
    ...
    store = SQLiteSessionMemoryStore.from_env()
    ...
    if loaded_memory:
        ...
        print("\nMemoria recuperada desde SQLite.\n")
    else:
    ...
    while True:
        ...
        if command == "/guardar":
            ...
            print("Memoria guardada en SQLite.\n")
            continue

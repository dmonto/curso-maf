...
from src.tools.support_tools import calculate_sla_deadline, draft_support_ticket
from src.tools.support_tools_controlled import get_service_status
from src.tools.migration_tools import classify_legacy_component
from src.tools.migration_tools import classify_legacy_component
from src.tools.prompt_migration_tools import analyze_legacy_prompt
